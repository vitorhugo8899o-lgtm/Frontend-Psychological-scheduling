...
import { GetHistoryAppoiment } from '../servicies/Psych';
import { useNavigate } from "react-router-dom";
import SidebarButton from '../componentes/SidebarButton';
import { useTheme } from '../context/ThemeContext';

export default function AppointmentHistoryPsych() {
                                        ...
                                        <div className="flex-1 space-y-3">
                                            ...
                                            <div className="space-y-1">
                                                <p className={`text-sm font-medium ${isDarkMode ? 'text-gray-300' : 'text-[#4A2E14]'
                                                    ...
                                                    {appointment.client?.fullname || "Cliente não informado"}
                                                </p>
                                                <p className={`text-xs ${isDarkMode ? 'text-gray-400' : 'text-[#8C5C32]'
                                                    }`}>
                                                    {appointment.client?.email || "Email não registrado."}
                                                </p>
                                            </div>
